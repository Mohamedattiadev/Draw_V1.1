...
import { deleteElement, duplicateElement, minmax, moveElementLayer, updateElement } from "../helper/element"
        ...
        <React.Fragment>
          ...
          <div className="group actions">
            ...
            <div className="innerGroup">
              <button
                type="button"
                onClick={() => deleteElement(selectedElement, setElements, setSelectedElement)}
                title="Delete"
                className="itemButton option"
              >
                <Delete />
              ...
              <button
                ...
                onClick={() => duplicateElement(selectedElement, setElements, setSelectedElement, 10)}
              >
                <Duplicate />
              </button>
            </div>
